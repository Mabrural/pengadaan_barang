              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-folder"></i> Master Barang<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="admin2.php?page=dataBarang">Daftar Barang</a></li>
                    </ul>
                  </li>

                  <li><a><i class="fa fa-database"></i> Asset dan Inventaris<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="admin2.php?page=dataInventaris">Storage Barang</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-edit"></i> Permintaan Barang<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="admin2.php?page=historyApprove2">History Permintaan Barang</a></li>
                  ...
                  <li><a><i class="fa fa-shopping-cart"></i> Pembelian Barang<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="admin2.php?page=invoicePembelian">Invoice Pembelian</a></li>
                    </ul>
                  </li>

                  <li><a><i class="fa fa-users"></i> Human Resources<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="admin2.php?page=reqCuti">Form Cuti</a></li>
                      <li><a href="admin2.php?page=historyCuti">History Cuti</a></li>
                    </ul>
                  </li>
        ...
        <div class="right_col" role="main">
          <?php
                    if(isset($_GET['page'])){
                        ...
                        switch ($page) {
                            case 'approve2':
                                include "page/admin_approve2/admin_aprove2.php";
                                break;
