              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-history"></i>History Permintaan<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="dirkeu.php?page=historyPermintaan">History Permintaan Barang</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-shopping-cart"></i> Pembelian Barang<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="dirkeu.php?page=invoicePembelian">Invoice Pembelian</a></li>
                    ...
                    <ul class="nav child_menu">
                     ...
                     <!--  <li class="nav-item">
                      ...
                      <!-- untuk menampilkan notif sekali lihat -->
                        <li class="nav-item">
                            <a href="dirkeu.php?page=approveCuti" class="nav-link">
                                Approve Cuti 
                                <?php
                      ...
                      <li><a href="dirkeu.php?page=historyApproveCuti">History Approve Cuti</a></li>
          ...
          <?php
                    if(isset($_GET['page'])){
                        ...
                        switch ($form) {
                            ...
                            case 'reject2':
                                include 'page/pembelian_barang/approve_pembelian/reject2.php';
                                break;
