...
// $req_barang = query("SELECT * FROM req_barang JOIN barang ON barang.kode_brg=req_barang.kode_brg ORDER BY barang.kode_brg");
$req_barang = query("SELECT * FROM req_barang JOIN barang ON barang.kode_brg=req_barang.kode_brg WHERE req_barang.status_req='Menunggu Persetujuan Dir. HRD' GROUP BY barang.kode_brg");
		...
		<div class="clearfix"></div>
			<div class="row">
				<div class="col-md-12 col-sm-12 ">
					<div class="x_panel">
						<div class="x_title">
							<h2>Ubah Data Purchase Order <small></small></h2>
							...
							<form action="" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
								...
								<div class="item form-group">
									...
									<div class="col-md-6 col-sm-6 ">
										<input type="date" name="tgl_po" id="tgl_po" required="required" class="form-control" value="<?= $po_barang['tgl_po']?>">
									</div>
								</div>
								...
								<div class="item form-group">
									...
									<div class="col-md-6 col-sm-6 ">
										<input id="qty_po" name="qty_po" class="form-control" type="number" min="0" value="<?= $po_barang['qty_po']?>">
									</div>
								</div>
								...
								<div class="item form-group">
									...
									<div class="col-md-6 col-sm-6 ">
										<input id="harga_po" name="harga_po" class="form-control" type="number" min="0" value="<?= $po_barang['harga_po']?>">
									</div>
								</div>
								...
								<div class="item form-group">
									...
									<div class="col-md-6 col-sm-6 ">
										<textarea id="ket_po" class="form-control" rows="4" name="ket_po" id="ket_po" style="resize:none;"><?= $po_barang['ket_po']?></textarea>
									</div>
									<input name="acc3" class="form-control" type="hidden" value="<?= $po_barang['acc3']?>">
									<input name="acc4" class="form-control" type="hidden" value="<?= $po_barang['acc4']?>">
