...
if (isset($_POST["submit"])) {
	...
	// cek apakah data berhasil diapprove atau tidak
	if(approveCuti($_POST) > 0 ) {
      ...
      <div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Konfirmasi Approve Cuti<small></small></h2>
