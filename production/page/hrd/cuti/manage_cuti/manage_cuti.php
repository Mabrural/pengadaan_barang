            ...
            <tbody>
              <tr class="even pointer">
               ...
               <!--  <td class=" "><?= $data['kategori_cuti'];?> </td>
                ...
                <!-- <td class=" last"><a href="?form=ubahManageCuti&id_manage_cuti=<?= $data["id_manage_cuti"]; ?>" class="btn btn-info btn-sm">Ubah </a> | <a href="?form=hapusManageCuti&id_manage_cuti=<?= $data["id_manage_cuti"]; ?>" onclick="return confirm('Anda yakin ingin menghapus data ini?')" class="btn btn-danger btn-sm">Hapus </a> | <a href="?form=detilKuota&id_emp=<?= $data['id_emp'];?>" class="btn btn-secondary btn-sm">Detil Kuota</a> 
                </td> -->
