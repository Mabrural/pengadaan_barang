      ...
      <div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Form Input Manage Cuti<small></small></h2>
								...
								<div class="x_content">
									...
									<form action="" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="number" name="kuota_cuti" id="kuota_cuti" required="required" class="form-control" min="0">
											</div>
										</div>
