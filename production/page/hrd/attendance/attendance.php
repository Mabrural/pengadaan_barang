...
?>
    <div class="x_panel">
      <div class="x_title">
        <h2>Data Attendance <small></small></h2>
        <a href="?form=tambahKaryawan" class="btn btn-primary btn-sm"><i class="fa fa-plus fa-sm"></i> Tambah Data</a>
          ...
          <table id="example" class="display" style="width:100%">
            <thead style="background-color: #2a3f54; color: #dfe5f1;">
              <tr class="headings">
                ...
                <th class="column-title">Tanggal Kehadiran</th>
