          ...
          <table id="example" class="display" style="width:100%">
            ...
            <tbody>
              <tr class="even pointer">
              	<?php 
              		$no = 1;
              		$query = "SELECT * FROM pembelian_barang JOIN req_barang ON req_barang.id_req_brg=pembelian_barang.id_req_brg JOIN satuan ON satuan.id_satuan=pembelian_barang.id_satuan JOIN vendor ON vendor.id_vendor=pembelian_barang.id_vendor JOIN barang ON barang.kode_brg=req_barang.kode_brg";
                ...
                <td class=" "><?= $data['qty_buy'];?></td>
                <td class=" "><?= $data['nama_satuan'];?></td>
                <td class=" "><?= $data['harga_brg'];?></td>
                <td class=" "><?= $data['harga_brg']*$data['qty_buy'];?></td>
                <td class=" "><?= $data['nama_vendor'];?></td>
                <td class=" "><?= $data['status_req'];?></td>
                
                <td class=" last"><a href="?form=ubahBarang&id_req_buy=<?= $data["id_req_buy"]; ?>" class="btn btn-info btn-sm">Ubah </a> | <a href="?form=hapusBarang&id_req_buy=<?= $data["id_req_buy"]; ?>" onclick="return confirm('Anda yakin ingin menghapus data ini?')" class="btn btn-danger btn-sm">Hapus </a>
                </td>
              </tr>
