            ...
            <tbody>
              <tr class="even pointer">
                ...
                echo '<a href="?form=app1Pembelian&id_po=' . $data["id_po"] . '" class="btn btn-info btn-sm">Approve</a>';
				        echo '<a href="?form=reject1&id_po=' . $data["id_po"] . '" class="btn btn-danger btn-sm">Reject</a>';
				    } else {
