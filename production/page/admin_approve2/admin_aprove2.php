          ...
          <table id="example" class="display" style="width:100%">
            ...
            <tbody>
              <tr class="even pointer">
		        ...
		        <?php } else { ?>
		          <td class=" last"><a href="?form=ubahApprove2&id_req_brg=<?= $data["id_req_brg"]; ?>" class="btn btn-info btn-sm">Approve </a> | <a href="?form=reject&id_req_brg=<?= $data["id_req_brg"]; ?>" class="btn btn-danger btn-sm">Reject </a>
